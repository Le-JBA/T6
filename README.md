...
Pull out the cables to full length. If the cables are too short, you may need to replace them with longer 20 AWG cables on the driver PCB.

You may want to replace the cooling paste, if so, do this now.
